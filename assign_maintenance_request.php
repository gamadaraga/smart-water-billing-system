...
<title>Web Based Water Billing System</title>
<style type="text/css">
#wrapper{
 width:100%;
 margin:0 auto;
...
<div id="wrapper">
 ...
 <div style="color:#F00; font-size:12px; margin-left:900px;"> 
  ...
  <ul class="nav nav-pills">
    ...
    <li><a href="bill.php"><span class="glyphicon glyphicon-check"></span>&nbsp;Billing</a></li>
    ...
    <li class="btn btn-default btn-xs"><a href="assign_maintenance_request.php"><span class="glyphicon glyphicon-list"></span>&nbsp; Maintenance Requests</a></li>
  </ul>
<hr color="#999999" />
    ...
    <!-------- home panel ----------------------------->
         ...
         <div class="panel panel-info">
            <div class="panel-heading">
                <div class="panel-title"><h5>Maintenance Requests</h5>
            </div>
            </div>
...
while($row = mysqli_fetch_array($result))
 ...
 echo "<td><a rel='facebox' href='assign.php?id=".$row['id']."'><button class=\"btn btn-default btn-xs\"><span class=\"glyphicon glyphicon-edit\"></span></button></a>| ";
 echo "<a rel='facebox' href='reject.php?id=".$row['id']."'><button class=\"btn btn-danger btn-xs\"><span class=\"glyphicon glyphicon-trash \"></span></button></td>";
  echo "</tr>";
  }
echo "</table>";
