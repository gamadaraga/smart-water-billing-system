...
<div id="wrapper">
  ...
  <ul class="nav nav-pills">
    ...
    <li class="btn btn-default btn-xs active"><a href="bill.php"><span class="glyphicon glyphicon-ETB"></span>&nbsp;Billing</a></li>
    <li><a href="user.php"><span class="glyphicon glyphicon-user"></span>&nbsp;Users</a></li>
    <li><a href="clients.php"><span class="glyphicon glyphicon-avatar"></span>&nbsp;Customers</a></li>
    <li ><a href="assign_maintenance_request.php"><span class="glyphicon glyphicon-list"></span>&nbsp;View Maintenance Request</a></li>
  </ul>
<hr color="#999999" />
      ...
      <div class="panel panel-info">
        ...
        <div class="panel-body">
          ...
          while($row = mysqli_fetch_array($result)) {
            ...
            echo "<td><a rel='facebox' href='paybill.php?id=".$row['id']."'><span class=\"btn btn-info btn-xs glyphicon glyphicon-etb\">Run</span> </a>| ";
