...
<div class="container">
<div id="wrapper">
  <h1><center><b>SMART WATER BILLING SYSTEM</b></center></h1>
  ...
  <ul class="nav nav-pills">
    <li class="btn btn-default btn-xs"><a href="officer_billing.php"><span class="glyphicon glyphicon-home"></span>&nbsp;Home</a></li>
    <li><a href="officer_bill.php"><span class="glyphicon glyphicon-ETB"></span>&nbsp;Billing</a></li>
  
    <li><a href="officer_customer.php"><span class="glyphicon glyphicon-list"></span>&nbsp;Customers</a></li>
  </ul>
<hr color="#999999" />
    ...
    <div class="col-md-4">
         <div class="panel panel-info">
            <div class="panel-heading">
             ...
             <a href="officer_bill.php"> <div class="panel-footer"><span class="alert-link glyphicon glyphicon-circle-arrow-right"></span>View</div></a>
         </div>
      </div>
    </div>
   <!--------- ########################################### ------>
