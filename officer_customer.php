...
<div id="wrapper">
  ...
  <ul class="nav nav-pills">
    ...
    <li><a href="officer_bill.php"><span class="glyphicon glyphicon-check"></span>&nbsp;Billing</a></li>

    <li class="btn btn-default btn-xs"><a href="officer_customer.php"><span class="glyphicon glyphicon-list"></span>&nbsp;Customers</a></li>
  </ul>
<hr color="#999999" />
  ...
  <!-------------------------- modal ends ---------------------------->
         ...
         <div class="panel panel-info">
            <div class="panel-heading">
                ...
                <button type="button" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#myModal"> + Add Customer</button>
