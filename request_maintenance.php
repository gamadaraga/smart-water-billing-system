...
<div id="wrapper">
  ...
  <ul class="nav nav-pills">
    ...
    <li class="btn btn-default btn-xs"><a href="request_maintenance.php"><span class="glyphicon glyphicon-user"></span>&nbsp;Request Maintenance</a></li>
      ...
      <div class="col-md-12 mt-6">
         <div class="panel panel-info">
            <div class="panel-heading">
                <div class="panel-title"><h5 style="font-size:24px; font-weight:bold;">Maintenance Request </h5></div>
            </div>
              <div class="panel-body">
              <form method="post" action="request.php">
<table width="500" border="0" height="250">
  <tr>
    <td>Problem Topic:</td>
    <td><input type="text" name="topic" size="26" placeholder="Enter maintenance topic" /></td>
  </tr>

  <tr>
    <td>Description:</td>
    <td>
      <textarea name="desc" cols="24" rows="6" placeholder="Write details of your meter problems----"></textarea>
    </td>
  </tr>
 
 
  <tr>
    <td><input type="submit" name="request" value="Request" class="btn btn-primary"/></td>
