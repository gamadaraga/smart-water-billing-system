...
<div id="wrapper">
  ...
  <ul class="nav nav-pills">
    <li class="btn btn-default btn-xs active"><a href="billing.php"><span class="glyphicon glyphicon-home"></span>&nbsp;Home</a></li>
    <li><a href="bill.php"><span class="glyphicon glyphicon-ETB"></span>&nbsp;Billing</a></li>
