 ...
 <h1>  <img src="images/logo.png"
  ...
  <ul class="nav nav-pills">
    ...
    <li><a href="view_assigned_date.php"><span class="glyphicon glyphicon-list"></span>&nbsp;View Maintenance Assigned Date</a></li>
        <li><a href="chat_bot.php"><span class="glyphicon glyphicon-list"></span>&nbsp;Chat with Bot</a></li>
  </ul>
<hr color="#999999" />
      ...
      <div class="col-md-4">
         <div class="panel panel-info">
            <div class="panel-heading">
                <div class="panel-title"><h5 style="font-size:24px; font-weight:bold;">WSM Mission</h5></div>
            </div>
              <div class="panel-body">
               Water and Sewage is established...............
              </div>
  ...
  <div class="col-md-4">
         <div class="panel panel-info">
            <div class="panel-heading">
                <div class="panel-title"><h5 style="font-size:24px; font-weight:bold;">WSM Vision</h5></div>
            </div>
              <div class="panel-body">
               Water and Sewage has mision...............
              </div>
      ...
      <div class="col-md-4">
         <div class="panel panel-info">
            <div class="panel-heading">
                <div class="panel-title"><h5 style="font-size:24px; font-weight:bold;">WSM Ethical Values</h5></div>
            </div>
              <div class="panel-body">
               Water and Sewage ethical values...............
              </div>
